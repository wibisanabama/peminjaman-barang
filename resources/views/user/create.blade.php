@extends('layouts.app', ['header' => 'Tambah User', 'title' => 'Tambah User - InvenTrack'])
@section('content')
<div class="max-w-2xl">
    ...
    <div class="rounded-2xl bg-slate-900/60 backdrop-blur border border-slate-800/50 p-6 sm:p-8">
        <form action="{{ route('user.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-slate-400 mb-2">Password <span class="text-red-400">*</span></label>
