...
@section('content')
<h2 class="text-xl font-semibold text-slate-100 mb-6">Masuk ke Akun</h2>
...
<p class="text-center text-sm text-slate-500 mt-6">
    Belum punya akun? <a href="{{ route('register') }}" class="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">Daftar di sini</a>
</p>
@endsection
